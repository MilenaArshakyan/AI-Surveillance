...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        MainWindow->resize(587, 493);
        centralwidget = new QWidget(MainWindow);
        centralwidget->setObjectName("centralwidget");
        gridLayoutWidget = new QWidget(centralwidget);
        gridLayoutWidget->setObjectName("gridLayoutWidget");
        gridLayoutWidget->setGeometry(QRect(130, 30, 251, 191));
        ...
        gridLayout->addWidget(lineEdit2, 1, 0, 1, 1);

        lineEdit3 = new QLineEdit(gridLayoutWidget);
        lineEdit3->setObjectName("lineEdit3");

        gridLayout->addWidget(lineEdit3, 2, 0, 1, 1);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        sub->setText(QCoreApplication::translate("MainWindow", "Submit", nullptr));
    } // retranslateUi
